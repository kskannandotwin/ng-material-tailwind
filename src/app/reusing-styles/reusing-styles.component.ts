...
@Component({
  selector: 'app-reusing-styles',
  templateUrl: './reusing-styles.component.html',
  styleUrls: ['./reusing-styles.component.scss']
})
export class ReusingStylesComponent {
  users = [
    ...
    { imgUrl: 'https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' }
  ];

  links = ['Home', 'Team', 'Projects', 'Reports'];
}
